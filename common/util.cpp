...
void init(GLFWwindow* &win, const char* title/* = u8"学习OpenGL"*/, const int screenWidth/* = 800*/, const int screenHeight/* = 600*/, const int versionMajor/* = 4*/, const int versionMinor/* = 6*/)
{
	glfwInit();
